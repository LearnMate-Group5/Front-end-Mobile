...
public class SubscriptionActivity extends AppCompatActivity implements SubscriptionView {
    ...
    private void loadCurrentSubscription() {
        ...
        subscriptionService.getCurrentSubscription().enqueue(new Callback<CurrentSubscriptionResponse>() {
            @Override
            public void onResponse(Call<CurrentSubscriptionResponse> call,
                    Response<CurrentSubscriptionResponse> response) {
                dismissLoadingDialog();
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Log.w("SubscriptionActivity", "No current subscription found - Response code: "
    ...
    private void loadSubscriptionPlans() {
        ...
        subscriptionService.getPlans().enqueue(new Callback<List<SubscriptionPlanResponse>>() {
            @Override
            public void onResponse(Call<List<SubscriptionPlanResponse>> call,
                    Response<List<SubscriptionPlanResponse>> response) {
                dismissLoadingDialog();
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    // Chỉ thêm các plans từ API (không thêm Current Plan nữa vì đã chuyển sang
                    // Settings)
                    ...
                    Toast.makeText(SubscriptionActivity.this, "Không thể tải danh sách gói đăng ký", Toast.LENGTH_SHORT)
                            .show();
                }
            }
            ...
            public void onFailure(Call<List<SubscriptionPlanResponse>> call, Throwable t) {
                ...
                Toast.makeText(SubscriptionActivity.this, "Lỗi khi tải gói đăng ký: " + t.getMessage(),
        ...
        subscriptionService.choosePlan(subscriptionId).enqueue(new Callback<ChoosePlanResponse>() {
            ...
            public void onResponse(Call<ChoosePlanResponse> call, Response<ChoosePlanResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(SubscriptionActivity.this, "Đăng ký thành công gói " + result.name + "!",
                            Toast.LENGTH_LONG).show();

                    // Refresh subscription trong SubscriptionManager để cache lại
                    com.example.LearnMate.managers.SubscriptionManager.getInstance(SubscriptionActivity.this)
                            .loadSubscriptionFromAPI();
    ...
    public static class SubscriptionPlan {
        ...
        public SubscriptionPlan(String name, long price, long originalPrice, int discount, String subtitle,
                String features, String type, boolean isCurrentPlan, String subscriptionId) {
            this.name = name;
            this.price = price;
        ...
        public String getFormattedPrice() {
            if (price == 0)
                return isCurrentPlan ? "Hoạt Động" : "Miễn Phí";
